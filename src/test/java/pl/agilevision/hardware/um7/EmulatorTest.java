...
//    setR_ok = um7cli.setDataRate(UM7Attributes.NmeaHealth, UM7Attributes.Frequency.HealthRate.Freq1_HZ);
//    System.out.println("Set NmeaHealth Rate " + (setR_ok ? "ok":"failed."));
