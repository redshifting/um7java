...
public interface UM7Constants {
  ...
  interface Registers {
    ...
    int H_CREG_GYRO_ALIGN1_1  = REG_HIDDEN | 0x31;
    int H_CREG_ACCEL_ALIGN1_1 = REG_HIDDEN | 0x52;
    int H_CREG_MAG_ALIGN1_1   = REG_HIDDEN | 0x73;
    int H_CREG_MAG_REF        = REG_HIDDEN | 0x7C;
  }
